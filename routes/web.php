...
Route::get('/RecordamosEsteMes', [App\Http\Controllers\inMemoriaController::class, 'thisMonth'])->name('RecordamosEsteMes');
Route::get('/RecordamosHoy', [App\Http\Controllers\inMemoriaController::class, 'today'])->name('RecordamosHoy');
Auth::routes();
