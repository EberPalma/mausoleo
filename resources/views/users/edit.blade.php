            ...
            <div class="section-image">
                ...
                <div class="row">
                    ...
                    <div class="card col-md-8">
                        ...
                        <div class="card-body">
                            <form method="post" action="/api/userupdate/{{ $user->id }}" autocomplete="off"
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="name" id="input-name" class="inname form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Jose') }}" value="{{ old('name', $user->name) }}" required autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ap_paterno" id="" class="inappa form-control" placeholder="{{ __('Gonzales') }}" value="{{ $user->ap_paterno }}" required autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ap_materno" id="" class="inapma form-control" placeholder="{{ __('Hernandez') }}" value="{{ $user->ap_materno }}" required autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" id="" class="inun form-control" placeholder="{{ __('JoseGH') }}" value="{{ $user->username }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="email"
                                               name="email" id="input-email" class="inemail form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" value="{{ old('email', $user->email) }}" required>
                            ...
                            <hr class="my-4" />
                            <form method="get" action="/api/changepassword/{{ $user->id }}">
                                @csrf
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', ()=>{
                            ...
                            btn.addEventListener('click',(e)=>{
                                e.preventDefault();
                                axios.post('/api/changepassword/{{ $user->id }}', {
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <div class="author">
                                    <a href="#">
                                        ...
                                        <h5 class="title">{{ $user->name }} {{ $user->ap_paterno }} {{ $user->ap_materno }}</h5>
                                    </a>
                                    <p class="description">
                                       <b>Nombre de Usuario:</b> {{ $user->username }} <br><br>
                            ...
                            <hr>
                             <center>  <h5> <span class="badge badge-warning">{{ $user->rol }}</span></h5> </center>
                        </div>
                    </div>
                </div>
            </div>
