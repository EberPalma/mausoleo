    ...
    <div class="container @auth-fluid @endauth">
        <nav>
            <ul class="footer-menu">
                <li>
                    <a href="https://www.creative-tim.com" class="nav-link" target="_blank">{{ __('Mausoleo Santa Clara') }}</a>
                </li>
                <li>
            ...
            <p class="copyright text-center">
                ...
                <a href="http://www.creative-tim.com">{{ __('Mausoleo Santa Clara') }}</a> &amp; <a href="https://www.updivision.com">{{ __('Updivision') }}</a> {{ __(', made with love for a better web') }}
            </p>
        </nav>
    </div>
</footer>