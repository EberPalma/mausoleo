                    ...
                    <div class="card col-md-8">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h3 class="mb-0">{{ __('Editar Promoción') }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form method="post" action="/api/promocionesupdate/{{ $producto->id }}" autocomplete="off"
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombre" class="form-control " placeholder="{{ __('Ejemplo: Urnas 2x1 (Opcional)' ) }}" value="{{ $producto->nombre }}" required autofocus>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="number" name="precio" id="precio" class="form-control" placeholder="{{ __('Ejemplo: 200.00 (Opcional)') }}" value="{{ $producto->precio }}" required autofocus>
                                    ...
                                    <div class="pl-lg-4">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            ...
                                            <textarea rows="5" name="descripcion" id="descripcion" class="form-control nomb" placeholder="{{ __('Ejemplo: ¡Disfruta de esta increible promoción 2x1! (Opcional)') }}" required autofocus>{{ $producto->description }}</textarea>
                                        </div>
                                        <hr>
                                    <div class="form-group">
